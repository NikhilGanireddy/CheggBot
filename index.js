...
//     apiKey: "sk-proj-WsxZrDXoCShOziCoCNNrT3BlbkFJcz2wsjv3lrqLpNrAlbMa",
// });
...
//
// // Telegram Bot setup
// // const token = "7220782785:AAFRtcHRNcVkcsrfGBv_lhHh2a9ljYx9DQw"
...
//     }
//
//     // console.log(`User: {\tuserName: ${userName},\tuserId: ${userId},\tChatId: ${chatId},\tmessageId: ${msgId}\t}`)
...
//         // console(msg.photo[msg.photo.length-1])
...
// });
//
// // Check Subscription samplebotaibot
...
// //     const chatId = msg.chat.id;
// //     const userName = msg.from.first_name
// //     await bot.sendMessage(chatId, `Hi ${userName}! I am CheggMasterBot, created and developed by Nikhil Ganireddy (thegdp). Please let me know the question you need help with, and a comprehensive, step-by-step solution will be provided!`, inlineKeyboard);
// // });
// //
// // // Check Subscription
// // bot.onText(/\/checksub/, async (msg) => {
// //     const chatId = msg.chat.id;
// //     const userId = msg.from.id;
// //     const userName = msg.from.first_name
// //     const subscriptionMessage = await checkSubscription(userId)
// //     await bot.sendMessage(chatId, `${subscriptionMessage}`, inlineKeyboard);
// // });
//
// // Admin command to add subscription
...
//         console.log(`Sent to userId: ${userId}, fileName: ${res.filename}`); // { filename: '/app/response.pdf' }
